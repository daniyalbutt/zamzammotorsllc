    ...
    <div class="breadcrumb__wrapper mb-25">
        <nav>
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Make - {{ $data->name }}</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="col-xxl-12 col-xl-12 col-lg-12">
        <div class="card__wrapper">
            <div class="card__title-wrap mb-20">
                <h5 class="card__heading-title">Edit Make Form</h5>
            </div>
			<form class="form" method="post" action="{{ route('makes.update', $data->id) }}">
				<div class="row gx-0 g-20 gy-20 align-items-center justify-content-center">
					...
					<div class="row gy-3">
						...
						<div class="col-12">
							<button type="submit" class="btn btn-primary">Update Make</button>
						</div>
					</div>
            	</div>
			</form>
