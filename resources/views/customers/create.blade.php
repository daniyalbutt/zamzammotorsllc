            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('lead_source') is-invalid @enderror" name="lead_source" required>
                        ...
                        <option value="WhatsApp" {{ old('lead_source') == 'WhatsApp' ? 'selected' : '' }}>WhatsApp</option>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('status') is-invalid @enderror" name="status" required>
                        ...
                        <option value="In Negotiation" {{ old('status') == 'In Negotiation' ? 'selected' : '' }}>In Negotiation</option>
