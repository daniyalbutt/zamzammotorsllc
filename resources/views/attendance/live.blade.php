                    ...
                    <form id="liveAttendanceFilter" class="row g-10 align-items-end">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" id="yearSelect" name="year">
                                @for ($i = 2023; $i <= 2026; $i++)
                                    <option value="{{ $i }}" {{ (int) $year == (int) $i ? 'selected' : '' }}>
                                        {{ $i }}</option>
                                @endfor
                            </select>
                        </div>
                                ...
                                <td>
                                    <span class="table-avatar">
                                        <a class="employee__avatar mr-5" href="{{ route('employees.show', $user->id) }}">
                                            <img class="img-48 border-circle" src="{{ $user->profileImage() }}"
                                                alt="User Image">
                                        </a>
                                ...
                                @for ($day = 1; $day <= $totalDaysInMonth; $day++)
                                    ...
                                    <td class="text-center">
                                        ...
                                        @else
                                            ...
                                            @elseif($dayAttendance['status'] == 'beforejoining')
                                                <i class="fa-solid fa-calendar-minus text-warning"
