    ...
    <div class="breadcrumb__wrapper mb-25">
        <nav>
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Model - {{ $data->name }}</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="col-xxl-12 col-xl-12 col-lg-12">
        <div class="card__wrapper">
            <div class="card__title-wrap mb-20">
                <h5 class="card__heading-title">Edit Model Form</h5>
            </div>
			<form class="form" method="post" action="{{ route('models.update', $data->id) }}">
