    ...
    <div class="col-xxl-12">
        <div class="card__wrapper">
            <div class="card__title-wrap mb-20">
                <h3 class="card__heading-title">Model List</h3>
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center justify-content-start gap-10">
                                @can('edit make')
                                <a href="{{ route('models.edit', $value->id) }}" class="table__icon edit"><i class="fa-sharp fa-light fa-pen"></i></a>
                                @endcan
                                @can('delete make')
                                <form action="{{ route('models.destroy', $value->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
